    ...
    public static int interrupt(int irq, int cmd, int param, Object args)
    {
        ...
        case INTERRUPT_SOFTWARE: // System calls
            ...
            case RAWREAD: // read a block of data from disk
                 ...
                 * the buffer wasn't available for sending (bufferReady == true)
                 * but then promptly looped back, found the buffer wasn't
                 * available for sending (bufferReady == true) and then went
                 * back to sleep
                 */
