...
public class Scheduler extends Thread
{
    ...
    public boolean deleteThread()
    {
        ...
        if(tcb == null) {
            ...
            // close any open file descriptors rather than decrement theccounts
            // to ensure that system-wide file table entries are removed when no
            // longer needed
            for(int i = 3; i < 32; i++)
                if(tcb.ftEnt[i] != null)
                    SysLib.close(i);
